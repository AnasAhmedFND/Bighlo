    ...
    return (
        <section className=' relative bottom-[42px] -z-20' >
            ...
            <div className="container left-1/2 -translate-x-1/2 absolute top-[210px] flex  items-center ">
                    ...
                    <div className=" w-[70%]  ">
                        <h1 className='text-5xl font-bold text-white '>Revolutionizing <br /> Artificial Intelligence <br /> (AI) with Transparency</h1>
                        <p className='text-white mt-6'>With the current trends in technology and the growing incorporation of Artificial <br />
