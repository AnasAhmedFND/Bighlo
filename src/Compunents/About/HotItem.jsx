            ...
            <div className="">
                <div className="md:flex  justify-between mt-2">
                    ...
                    <div className=" md:w-[48%] relative ">
                        ...
                        <div className="absolute md:top-[80px] top-[1px] px-4 ">
                            <h6 className='font-bold md:text-4xl'>Create your <br /> unique style</h6>
                            <p className='md:mt-2'>Free and easy way to bring <br />your ideas to life</p>
                            <button className='border md:mt-4 mt-2 py-2 px-5 bg-white rounded-2xl cursor-pointer '>Explore More</button>
                        </div>
                    </div>

                </div>

                <div className=" grid grid-flow-rows md:grid-cols-4 grid-cols-2 gap-2 justify-between mt-5 ">

                    <div className="border rounded-t-2xl md:w-[95%] md:mt-0 mt-2 text-center ">
                        <img className='rounded-2xl  w-full ' src="/about/benner/main1 (1).png " alt="man" />
                    ...
                    <div className="border rounded-t-xl md:w-[95%] md:mt-0 mt-2 text-center ">
