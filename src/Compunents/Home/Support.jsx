...
const Support = () => {
    return (
        <>
            <section className='py-10 md:px-0 px-2  ' style={{
                backgroundImage: "url('/home/bgai.png') ",
                ...
                <div className="md:flex  md:justify-between">
                    <div className=" text-white md:w-[35%]  md:ml-[590px] md:flex flex-col justify-center">
                        ...
                        <div className="flex  justify-between items-center">
                            ...
                            <button className='border rounded-2xl bg-blue-500 text-white px-5 py-2 md:text-[14px]  '>More Answer</button>
